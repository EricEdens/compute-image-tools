...
func TestRun_HappyCase_CollectAllTraceLogs(t *testing.T) {
	...
	mockLogger.EXPECT().Trace("log-a")
	mockLogger.EXPECT().Trace("log-b")
	mockLogger.EXPECT().Trace("log-c")
	mockLogger.EXPECT().Trace("log-d")
