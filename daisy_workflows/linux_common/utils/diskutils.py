...
def MountDisk(disk):
  ...
  # Distro-specific logic can inspect these fields.
  g.gcp_image_distro = g.inspect_get_distro(roots[0])
  g.gcp_image_major = g.inspect_get_major_version(roots[0])
  g.gcp_image_minor = g.inspect_get_minor_version(roots[0])
